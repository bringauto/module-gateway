...
public:
	 ...
	 * DISCONNECTED and transitions it to CONNECTING in order to prevent
...
private:
	/// Represents the current state of the QUIC connection lifecycle
	 ...
	 * @return Null-terminated string describing the connection state.
	 */
